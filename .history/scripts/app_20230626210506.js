...
const p1SelectedFieldSet = [];
const p2SelectedFieldSet = [];
let matches = 0;
...
const scorePanel = document.getElementById('score-container');
const p1NameScore = document.querySelector('#p1-score p');
const p2NameScore = document.querySelector('#p2-score p');
const player1Score = document.querySelector('#score-players-div span');
const player2Score = document.querySelector('#score-players-div span');
