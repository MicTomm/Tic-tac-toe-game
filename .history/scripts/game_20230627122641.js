...
function showingOrHidingTurnPanelAndGameoverPanel(gameOverDisplayValue, pPlayerTurnDisplayValue){
    gameOver.style.display = gameOverDisplayValue;
    pPlayerTurn.style.display = pPlayerTurnDisplayValue;
}