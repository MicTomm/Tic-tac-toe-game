...
function savePlayerConfig(event) {
    ...
    */
    if (!playerName) {
        ...
        inputValidationErrorContainer.style.justifyContent = 'top';
        inputValidationErrorContainer.style.alignItems = 'top';
        inputValidationError.textContent = 'Please, enter a name';
        return;
    } 
    else {
